...
// GET — any authenticated user in the org (renderer needs this)
export async function GET(
  ...
  if (!page || page.organizationId !== session.organizationId) {
...
export async function PATCH(
  ...
  const updated = await prisma.customPage.update({
    where: { id },
    data:  { name, icon, description, widgets: toInput(widgets), showInSidebar, sidebarOrder },
  })
