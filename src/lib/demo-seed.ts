...
async function seedDemoContent(orgId: string, adminUserId: string, industryLabel: string, slug: string) {
  ...
  if (firstLocId) {
    const qrData = industryKey === "property"
      ? [
          // Riverside Apartments (locationIds[0])
          {
            organizationId: orgId,
            createdById:    adminUserId,
            name:           "Unit 204 — Maintenance Request",
            description:    "Report a maintenance problem, plumbing issue, HVAC concern, or facility problem in your unit.",
            area:           "Unit 204",
            locationId:     locationIds[0],
          ...
          },
          {
            ...
            createdById:    adminUserId,
            name:           "Lobby Entry",
            description:    "Report a maintenance problem, access issue, cleanliness concern, or safety hazard in the lobby.",
            area:           "Lobby",
            locationId:     locationIds[0],
            reportingMode:  "PUBLIC_ISSUE",
            defaultCategory:"FACILITY",
          ...
          // Building A (locationIds[3] — child of Riverside Apartments)
          {
            organizationId: orgId,
            createdById:    adminUserId,
            name:           "Laundry Room — Building A",
            description:    "Report a broken machine, water leak, cleanliness problem, or other laundry room issue.",
            area:           "Laundry Room",
            locationId:     locationIds[3] ?? locationIds[0],
            reportingMode:  "PUBLIC_ISSUE",
            defaultCategory:"MAINTENANCE",
            allowedCategories: [],
            isActive:       true,
          },
          // North Commerce Center (locationIds[1])
          {
            organizationId: orgId,
            createdById:    adminUserId,
            name:           "Parking Garage",
            description:    "Report a safety hazard, lighting issue, access problem, or facility concern in the parking structure.",
            area:           "Parking Garage",
          ...
          },
          {
            ...
            createdById:    adminUserId,
            name:           "Rooftop Access",
            description:    "Report a maintenance problem, equipment issue, access concern, or safety hazard on the rooftop.",
            area:           "Rooftop",
            locationId:     locationIds[1] ?? locationIds[0],
            reportingMode:  "PUBLIC_ISSUE",
            defaultCategory:"MAINTENANCE",
          ...
          // Main Street Retail Center (locationIds[2])
          {
            organizationId: orgId,
            createdById:    adminUserId,
            name:           "Suite 310",
            description:    "Report a maintenance problem, plumbing issue, HVAC concern, electrical problem, or facility issue in your suite.",
            area:           "Suite 310",
            locationId:     locationIds[2] ?? locationIds[0],
            reportingMode:  "PUBLIC_ISSUE",
            defaultCategory:"TENANT_REQUEST",
            allowedCategories: [],
            isActive:       true,
          },
        ]
